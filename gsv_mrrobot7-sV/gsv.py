...
# 
# NAME
#           nmap_gsv - Generate nmap version detection command (-sV) from the XML-output file generated by an nmap scan.
#
# SYNOPSIS
#           python3 nmap_gsv.py -h
#           python3 nmap_gsv.py -x ./nmap_report.xml
#           python3 nmap_gsv.py -x ./nmap_report.xml -p ports
# 
# AUTHOR
